        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                link.download =
                    ...
                    ".xlsx"; // Dinamis nama file
                link.click();
            },
            error: function (xhr, status, error) {
                console.error("Error exporting data:", error);
                alert(
                    "Failed to export data. Please check your filters or try again.",
                );
            },
        });
    });
...
function showWarning(message) {
    const warningMessage =
        message || "Please check the input data and try again.";
    Swal.fire({
        icon: "warning",
        title: "Warning",
        text: warningMessage,
