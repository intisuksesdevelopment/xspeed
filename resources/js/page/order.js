...
//                     " - " +
//                     document.getElementById("installment-select").value;
//                 document
//                     .getElementById("div-account")
...
//                     selectedOption.getAttribute("data-method"),
//                 );
...
//         let stock = parseInt(
//             document.getElementById(`sales-stock-${itemId}`).textContent,
//             10,
//         );
//         let price = parseFloat(
//             document.getElementById(`sales-price-${itemId}`).textContent,
//         );
...
//         let discountRate =
//             parseFloat(document.getElementById("discount-value").textContent) /
//                 100 || 0;
...
//             `-${discount.toLocaleString("de-DE", options)}`;
...
//                 (supplier) => supplier.uuid === supplierId,
//             )[0];
...
//                     const modalId = data.success
//                         ? "success-alert-modal"
//                         : "danger-alert-modal";
//                     const messageId = data.success
//                         ? "success-message"
//                         : "danger-message";
//                     let modalMessage = data.success
//                         ? data.message
//                         : "Submission failed";
...
//                             modalMessage = Object.values(data.message)
//                                 .flat()
//                                 .join(", ");
//                         } else {
...
//                                 "transaction-id",
//                             ).innerText = generateTransactionID("ORD");
//                             modalMessage =
...
//                     new bootstrap.Modal(
//                         document.getElementById("danger-alert-modal"),
//                     ).show();
