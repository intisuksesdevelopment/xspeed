...
<div class="header">
    ...
    <div class="header-left active">
        ...
        <a href="{{ url('index') }}" class="logo logo-white">
            <img src="{{ asset('assets/admin/assets/img/logo-white.png') }}" alt="">
        </a>
        <a href="{{ url('index') }}" class="logo-small">
            <img src="{{ asset('assets/admin/assets/img/logo-small.png') }}" alt="">
        </a>
    ...
    <ul class="nav user-menu">
                            ...
                            <ul class="customers">
                                <li>
                                    <a href="javascript:void(0);">Aron Varu<img
                                            src="{{ asset('assets/admin/assets/img/avatars/avatar1.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Jonita<img
                                            src="{{ asset('assets/admin/assets/img/avatars/avatar2.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">Aaron<img
                                            src="{{ asset('assets/admin/assets/img/avatars/avatar3.jpg') }}"
                                            alt="" class="img-fluid"></a>
                                </li>
                            </ul>
                        </div>
        ...
        <li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('assets/admin/assets/img/store/store-02.png') }}" alt="Store Logo"
                        class="img-fluid">
                    Grocery Apex
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('assets/admin/assets/img/store/store-03.png') }}" alt="Store Logo"
                        class="img-fluid">
                    Grocery Bevy
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('assets/admin/assets/img/store/store-04.png') }}" alt="Store Logo"
                        class="img-fluid">
                    Grocery Eden
                </a>
            </div>
        ...
        <li class="nav-item dropdown has-arrow flag-nav nav-item-box">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('assets/admin/assets/img/flags/fr.png') }}" alt="" height="16">
                    French
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('assets/admin/assets/img/flags/es.png') }}" alt="" height="16">
                    Spanish
                </a>
                <a href="javascript:void(0);" class="dropdown-item">
                    <img src="{{ asset('assets/admin/assets/img/flags/de.png') }}" alt="" height="16">
                    German
                </a>
            </div>
        </li>
