                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        ...
                                        <a class="p-2" href="javascript:void(0);"
                                            onclick="deleteData({{ $subcategory['id']}})">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('subCategoryAddForm').addEventListener('submit', function(event) {
                ...
                .then(data => {
                    ...
                    document.getElementsByName('cancel-button').click();
                })
                .catch(error => {
                    Swal.close();
                    submitButton.disabled = false;
            ...
            document.getElementById('subCategoryEditForm').addEventListener('submit', function(event) {
                event.preventDefault();
                ...
                .catch(error => {
                    document.getElementById('failed-message').textContent = 'Submission failed: ' + error.message;
                    new bootstrap.Modal(document.getElementById('danger-alert-modal')).show();
                    console.error('Submission failed:', error);
                    submitButton.disabled = false;
                });
