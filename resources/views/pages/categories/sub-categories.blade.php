                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($subcategory['status'] == 0)
                                                <span
                                                    class="badge badge-linesuccess">{{ $subcategory['availability'] }}</span>
                                            @else
                                                <span
                                                    class="badge badge-linedanger">{{ $subcategory['availability'] }}</span>
                                            @endif
                                        </td>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.deleteSubcategory = function(id) {
                deleteData(`{{ route('subcategory-delete', ':id') }}`, id, document.querySelector(
