                            ...
                            <form id="customerAddForm" method="post" action="{{ route('customer-add') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 pe-0">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" name="limit_transaction" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 pe-0">
                                ...
                                <div class="modal-footer-btn">
                                    ...
                                    <button type="submit" class="btn btn-submit"
                                        id="submit-add-button">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <form id="customerEditForm" method="post" action="{{ route('customer-update') }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 pe-0">
                                        <div class="mb-3">
                                            <label class="form-label">Limit Transaction</label>
                                            <input type="number" name="limit_transaction" id="limit_transaction"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 pe-0">
                                        <div class="mb-3">
                                            <label class="form-label">Limit Debt</label>
                                            <input type="number" name="limit_debt" id="limit_debt"
                                                class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                ...
                                <div class="modal-footer-btn">
                                    <button type="button" class="btn btn-cancel me-2"
                                        data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" class="btn btn-submit"
                                        id="submit-edit-button">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="bar-code-view d-none">
                                                <img src="{{ asset('build/img/barcode/barcode1.png') }}"
                                                    alt="barcode">
                                                <a class="printimg">
                                                    <img src="{{ asset('build/img/icons/printer.svg') }}"
                                                        alt="print">
                                                </a>
                                            </div>
