                        ...
                        <form id="categoryAddForm" method="post" action="{{ route('category-add') }}" enctype="multipart/form-data" onsubmit="event.preventDefault(); handleCategoryFormSubmit(this, 'submit-add-button');">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="profile-pic-upload mb-0">
                                    <div class="profile-pic brand-pic" id="add-category-preview-container" style="cursor: pointer;" onclick="openImagePreview('add-category')">
                                        <span id="add-category-placeholder"><i data-feather="plus-circle" class="plus-down-add"></i> Add Image</span>
                                        <img id="add-category-preview" src="" alt="" style="display: none; width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                    <div class="image-upload mb-0">
                                        <input type="file" name="image_upload" id="add-category-file" onchange="previewImage(this, 'add-category')">
                                        <div class="image-uploads">
                                            <h4>Change Image</h4>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer-btn">
                                <button type="button" class="btn btn-cancel me-2" data-bs-dismiss="modal" name="cancel-button">Cancel</button>
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="categoryEditForm" method="post" action="{{ route('category-update') }}" enctype="multipart/form-data" onsubmit="event.preventDefault(); handleCategoryFormSubmit(this, 'submit-edit-button');">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Image</label>
                                <div class="profile-pic-upload mb-0">
                                    <div class="profile-pic brand-pic" id="edit-category-preview-container" style="cursor: pointer;" onclick="openImagePreview('edit-category')">
                                        <span id="edit-category-placeholder"><i data-feather="plus-circle" class="plus-down-add"></i> Add Image</span>
                                        <img id="edit-category-preview" src="" alt="" style="display: none; width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                    <input type="hidden" id="edit-category-current-image-url" value="">
                                    <div class="image-upload mb-0">
                                        <input type="file" name="image_upload" id="edit-category-file" onchange="previewImage(this, 'edit-category')">
                                        <div class="image-uploads">
                                            <h4>Change Image</h4>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-footer-btn">
                                <button type="button" class="btn btn-cancel me-2" data-bs-dismiss="modal" id="cancel-edit-button">Cancel</button>
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="subCategoryAddForm" method="post" action="{{ route('subcategory-add') }}" enctype="multipart/form-data" onsubmit="event.preventDefault(); handleSubCategoryFormSubmit(this, 'submit-add-button', 'status-add');">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Image</label>
                                <div class="profile-pic-upload mb-0">
                                    <div class="profile-pic brand-pic" id="add-subcategory-preview-container" style="cursor: pointer;" onclick="openImagePreview('add-subcategory')">
                                        <span id="add-subcategory-placeholder"><i data-feather="plus-circle" class="plus-down-add"></i> Add Image</span>
                                        <img id="add-subcategory-preview" src="" alt="" style="display: none; width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                    <div class="image-upload mb-0">
                                        <input type="file" name="image_upload" id="add-subcategory-file" onchange="previewImage(this, 'add-subcategory')">
                                        <div class="image-uploads">
                                            <h4>Change Image</h4>
                                        </div>
                                    </div>
...
<!-- Edit Category -->
<div class="modal fade" id="edit-sub-category">
    <div class="modal-dialog modal-dialog-centered custom-modal-two">
        <div class="modal-content">
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="subCategoryEditForm" method="post" action="{{ route('subcategory-update') }}" enctype="multipart/form-data" onsubmit="event.preventDefault(); handleSubCategoryFormSubmit(this, 'submit-edit-button', 'status-edit');">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Image</label>
                                <div class="profile-pic-upload mb-0">
                                    <div class="profile-pic brand-pic" id="edit-subcategory-preview-container" style="cursor: pointer;" onclick="openImagePreview('edit-subcategory')">
                                        <span id="edit-subcategory-placeholder"><i data-feather="plus-circle" class="plus-down-add"></i> Add Image</span>
                                        <img id="edit-subcategory-preview" src="" alt="" style="display: none; width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                    <input type="hidden" id="edit-subcategory-current-image-url" value="">
                                    <div class="image-upload mb-0">
                                        <input type="file" name="image_upload" id="edit-subcategory-file" onchange="previewImage(this, 'edit-subcategory')">
                                        <div class="image-uploads">
                                            <h4>Change Image</h4>
                                        </div>
                                    </div>
                ...
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="brandAddForm" method="post" action="{{ route('brand-add') }}" enctype="multipart/form-data" onsubmit="event.preventDefault(); handleBrandFormSubmit(this, 'submit-add-button', 'status-add');">
                            ...
                            <div class="modal-footer-btn">
                                <button type="button" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-submit" id="submit-add-button">Create
                                    Brand</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="brandEditForm" method="post" action="{{ route('brand-update') }}" enctype="multipart/form-data" onsubmit="event.preventDefault(); handleBrandFormSubmit(this, 'submit-edit-button', 'status-edit');">
                            ...
                            <div class="modal-footer-btn">
                                <button type="button" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-submit" id="submit-edit-button">Edit
                                    Brand</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="rackAddForm" method="post" action="{{ route('rack-add') }}" enctype="multipart/form-data" onsubmit="event.preventDefault(); handleRackFormSubmit(this, 'submit-add-button', 'status-add');">
                            ...
                            <div class="row">
                                ...
                                <label class="form-label">Image</label>
                                <div class="profile-pic-upload mb-3">
                                    <div class="profile-pic brand-pic" id="add-rack-preview-container" style="cursor: pointer;" onclick="openRackImagePreview('add-rack')">
                                        <span id="add-rack-placeholder"><i data-feather="plus-circle" class="plus-down-add"></i> Add Image</span>
                                        <img id="add-rack-preview" src="" alt="" style="display: none; width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                    <div class="image-upload mb-0">
                                        <input type="file" name="image_url" id="add-rack-file" onchange="previewRackImage(this, 'add-rack')">
                                        <div class="image-uploads">
                                            <h4>Change Image</h4>
                                        </div>
                                    </div>
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="rackEditForm" method="post" action="{{ route('rack-update') }}" enctype="multipart/form-data" onsubmit="event.preventDefault(); handleRackFormSubmit(this, 'submit-edit-button', 'status-edit');">
                            ...
                            <div class="row">
                                ...
                                <label class="form-label">Image</label>
                                <div class="profile-pic-upload mb-3">
                                    <div class="profile-pic brand-pic" id="edit-rack-preview-container" style="cursor: pointer;" onclick="openRackImagePreview('edit-rack')">
                                        <span id="edit-rack-placeholder"><i data-feather="plus-circle" class="plus-down-add"></i> Add Image</span>
                                        <img id="edit-rack-preview" src="" alt="" style="display: none; width: 100%; height: 100%; object-fit: cover;">
                                    </div>
                                    <input type="hidden" id="edit-rack-current-image-url" value="">
                                    <div class="image-upload mb-0">
                                        <input type="file" name="image_url" id="edit-rack-file" onchange="previewRackImage(this, 'edit-rack')">
                                        <div class="image-uploads">
                                            <h4>Change Image</h4>
                                        </div>
                                    </div>
                ...
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="subrackAddForm" method="post" action="{{ route('subrack-add') }}" onsubmit="event.preventDefault(); handleSubRackFormSubmit(this, 'submit-subrack-add-button', 'status-add');">
                            ...
                            <div class="modal-footer-btn">
                                <button type="button" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-submit" id="submit-subrack-add-button">Create
                                    Sub Rack</button>
                            </div>
                        </form>
                    </div>
                ...
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body new-employee-field">
                        <form id="subrackEditForm" method="post" action="{{ route('subrack-update') }}" onsubmit="event.preventDefault(); handleSubRackFormSubmit(this, 'submit-subrack-edit-button', 'edit-status');">
                            ...
                            <div class="modal-footer-btn">
                                <button type="button" class="btn btn-cancel me-2" data-bs-dismiss="modal">Cancel</button>
                                <button type="submit" class="btn btn-submit" id="submit-subrack-edit-button">Edit
                                    Sub Rack</button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal-content">
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form id="unitAddForm" method="post" action="{{ route('unit-add') }}" onsubmit="event.preventDefault(); handleUnitFormSubmit(this, 'submit-add-button', 'status-add');">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label">Unit</label>
        ...
        <div class="modal-content">
            <div class="page-wrapper-new p-0">
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form id="unitEditForm" method="post" action="{{ route('unit-update') }}" onsubmit="event.preventDefault(); handleUnitFormSubmit(this, 'submit-edit-button', 'status-edit');">
                            @csrf
                            <div class="mb-3 d-none">
                                <label class="form-label">Id</label>
                                <input type="text" id="id" name="id" class="form-control">
                ...
                <div class="content">
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="{{ url('varriant-attributes') }}">
                            ...
                            <div class="input-blocks">
                                <label class="form-label">Variant</label>
                                <input class="input-tags form-control" type="text" data-role="tagsinput" name="specialist" value="S,M,XL">
                                <span class="tag-text">Enter value separated by comma</span>
                            </div>
                            {{-- <div class="mb-0">
                                    <div
                            ...
                            <div class="col-sm-4">
                                <div class="barcode-scanner-link text-center">
                                    ...
                                    <div class="barscaner-img">
                                        <img src="{{ asset('build/img/barcode/barcode-01.png') }}" alt="Barcode" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="barcode-scanner-link text-center">
                                    ...
                                    <p>Price: $300</p>
                                    <div class="barscaner-img">
                                        <img src="{{ asset('build/img/barcode/barcode-02.png') }}" alt="Barcode" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                    ...
                    <div class="modal-body custom-modal-body">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="barcode-scanner-link text-center">
                                    <div class="barscaner-img">
                                        <img src="{{ asset('build/img/barcode/qr-code.png') }}" alt="Barcode" class="img-fluid">
                                    </div>
                                    <p>Ref No :32RRR554 </p>
                                </div>
                            </div>
                        ...
                        <div class="chat-options chat-option-profile">
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <a href="{{ url('audio-call') }}" class="btn btn-outline-light " data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Voice Call">
                                        <i class="bx bx-phone"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="{{ url('chat') }}" class="btn btn-outline-light" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Chat">
                                        <i class="bx bx-message-square-dots"></i>
                                    </a>
                                </li>
                                <li class="list-inline-item ">
                                    <a href="{{ url('video-call') }}" class="btn btn-outline-light profile-open" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Video Call">
        ...
        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
            ...
            <ul class="mb-4">
                <li class="mb-4">
                    ...
                    <p class="d-flex align-items-center location border-0"><img src="{{ asset('build/img/icons/folder.svg') }}" alt="Folder" class="me-2">Website Backup for
                        the Design team</p>
                </li>
                <li class="mb-4">
                    <div class="d-flex align-items-center mb-2">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a class="delete-set"><img src="{{ asset('build/img/icons/delete.svg') }}" alt="svg')}}"></a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                ...
                <div class="content p-0">
                    <div class="page-header p-4 mb-0">
                        ...
                        <ul class="table-top-head">
                            ...
                            <li>
                                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><img src="{{ asset('build/img/icons/pdf.svg') }}" alt="img"></a>
                            </li>
                            <li>
                                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Excel"><img src="{{ asset('build/img/icons/excel.svg') }}" alt="img"></a>
                            </li>
                            <li>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="productimgname">
                                                            <a href="javascript:void(0);" class="product-img stock-img">
                                                                <img src="{{ asset('build/img/products/stock-img-03.png') }}" alt="product">
                                                            </a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="productimgname">
                                                            <a href="javascript:void(0);" class="product-img stock-img">
                                                                <img src="{{ asset('build/img/products/stock-img-05.png') }}" alt="product">
                                                            </a>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="productimgname">
                                                        <a href="javascript:void(0);" class="product-img">
                                                            <img src="{{ asset('build/img/products/product6.jpg') }}" alt="product">
                                                        </a>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="productimgname">
                                                        <a href="javascript:void(0);" class="product-img">
                                                            <img src="{{ asset('build/img/products/product7.jpg') }}" alt="product">
                                                        </a>
                                                        <a href="javascript:void(0);">Apple Earpods</a>
                                                    </div>
                                                </td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-sm-2 col-2 p-0">
                                                <div class="add-icon tab">
                                                    <a class="btn btn-filter" data-bs-toggle="modal" data-bs-target="#add-units"><img src="{{ asset('build/img/icons/plus1.svg') }}" alt="img">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="table-top">
                                <div class="search-set">
                                    <div class="search-input">
                                        <a class="btn btn-searchset d-flex align-items-center h-100"><img src="{{ asset('build/img/icons/search-white.svg') }}" alt="img"></a>
                                    </div>
                                </div>
                                <div class="wordset">
                                    <ul>
                                        <li>
                                            <a class="d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><img src="{{ asset('build/img/icons/pdf.svg') }}" alt="img"></a>
                                        </li>
                                        <li>
                                            <a class="d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="top" title="Excel"><img src="{{ asset('build/img/icons/excel.svg') }}" alt="img"></a>
                                        </li>
                                        <li>
                        ...
                        <div class="tab-pane fade" id="return" role="tabpanel">
                            <div class="table-top">
                                ...
                                <div class="wordset">
                                    <ul>
                                        <li>
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf" class="d-flex align-items-center justify-content-center"><img src="{{ asset('build/img/icons/pdf.svg') }}" alt="img"></a>
                                        </li>
                                        <li>
                                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="Excel" class="d-flex align-items-center justify-content-center"><img src="{{ asset('build/img/icons/excel.svg') }}" alt="img"></a>
                                        </li>
                                        <li>
                ...
                <div class="tabs-sets">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="onhold" role="tabpanel" aria-labelledby="onhold-tab">
                            ...
                            <div class="order-body" id="sales-hold-list">
                        ...
                        <div class="tab-pane fade" id="unpaid" role="tabpanel">
                            ...
                            <div class="order-body" id="sales-unpaid-list">
                            </div>
                        </div>
                        <div class="tab-pane fade" id="paid" role="tabpanel">
                            ...
                            <div class="order-body" id="sales-paid-list">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="shift">
                            <ul class="nav nav-pills modal-table-tab" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-add-break-tab" data-bs-toggle="pill" data-bs-target="#pills-add-break" type="button" role="tab" aria-controls="pills-add-break" aria-selected="false">Break
                                        Timings</button>
                                </li>
                            </ul>
                    ...
                    <div class="modal-body custom-modal-body">
                        <form action="shift">
                            <ul class="nav nav-pills modal-table-tab" id="pills-tab2" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="pills-edit-break-tab" data-bs-toggle="pill" data-bs-target="#pills-edit-break" type="button" role="tab" aria-controls="pills-edit-break" aria-selected="false">Break
                                        Timings</button>
                                </li>
                            </ul>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="productdetails">
                                            ...
                                            <ul class="product-bar">
                                                ...
                                                <li>
                                                    <h4>Category</h4>
                                                    <h6 id="modal-product-category"></h6>
                                                </li>
                                                <li>
                                                    <h4>Sub Category</h4>
                                                    <h6 id="modal-product-subcategory"></h6>
                                                </li>
                                                <li>
                                                    <h4>Brand</h4>
                                                    <h6 id="modal-product-brand"></h6>
                                                </li>
                                                <li>
                                                    <h4>Unit</h4>
                                                    <h6 id="modal-product-unit"></h6>
                                                </li>
                                                <li>
                                                    <h4>SKU</h4>
                                                    <h6 id="modal-product-sku"></h6>
                                                </li>
                                                <li>
                                                    <h4>Minimum Qty</h4>
                                                    <h6 id="modal-product-min-qty"></h6>
                                                </li>
                                                <li>
                                                    <h4>Quantity</h4>
                                                    <h6 id="modal-product-qty"></h6>
                                                </li>
                                                <li>
                                                    <h4>Basic Price</h4>
                                                    <h6 id="modal-product-basic-price"></h6>
                                                </li>
                                                <li>
                                                    <h4>Sell Price</h4>
                                                    <h6 id="modal-product-sell-price"></h6>
                                                </li>
                                                <li>
                                                    <h4>Status</h4>
                                                    <h6 id="modal-product-status"></h6>
                                                </li>
                                                <li>
                                                    <h4>Description</h4>
                                                    <h6 id="modal-product-description"></h6>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                        ...
                        <form id="userAddForm" method="post" action="{{ route('user-add') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-blocks">
                                        <label>Note : </label>
                                        <small class="text-danger">Password must be at least 8 characters long
                                            and include at least one letter, one number, and one special
                                            character.</small>
                                    </div>
                                </div>
        ...
        <div class="modal-content modal-filled bg-danger">
            <div class="modal-body p-4">
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-cancel my-2" id="alert-danger-button" data-bs-dismiss="modal">Continue</button>
                </div>
            </div>
        </div>
    </div>
