...
<div class="container my-5">
	<div class="row">
        <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '>';">
            <ol class="breadcrumb fon">
                <li class="breadcrumb-item"><a href="{{ route('main') }}">{{ (__('messages.dashboard')) }}</a>
                </li>
				<li class="breadcrumb-item"><a href="{{ route('all-product-category', ['categoryCode' => $data['product']['category']['code']]) }}">{{ ($data['product']['category']['name']) }}</a>
                </li>
