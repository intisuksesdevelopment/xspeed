...
@extends('pages.layout.mainlayout')s
@section('content')
                                                        ...
                                                        <select class="select2 form-control" name="unit">
                                                            @foreach ($units as $unit)
                                                                @if ($unit['unit'] == $item['unit'])
                                                                    <option value="{{ $unit['unit'] }}" selected>
                                                                        {{ $unit['unit'] .
                                                                            ' -
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ' .
                                                                            $unit['name'] }}
                                                    ...
                                                    <div class="col-lg-4 col-sm-6 col-12">
                                                        <div class="mb-3 add-product">
                                                            ...
                                                            <select class="select form-control" name="status">
                                                                <option value="0"
                                                                    {{ $item['status'] == 0 ? 'selected' : '' }}>Available
                                                                </option>
                                                                <option value="1"
                                                                    {{ $item['status'] == 1 ? 'selected' : '' }}>Deleted
                                                                </option>
                                                                <option value="2"
                                                                    {{ $item['status'] == 2 ? 'selected' : '' }}>Not Active
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="col-lg-3 col-sm-6 col-12">
                                                                <div class="input-blocks add-product">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        name="image{{ $i }}"
                                                                        value="{{ isset($item['images'][$i]) ? $item['images'][$i]['path'] : '' }}">
                                                                </div>
                                                            </div>
                                                        @endfor
