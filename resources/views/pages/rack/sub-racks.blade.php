                        ...
                        <div class="col-md-5">
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- Input -->
                                    <input type="text" class="form-control" :placeholder="`{{ __('label.searchby') }} ${filters.searchBy}...`" x-model="filters.search" @keyup.debounce.500ms="fetchSubRacks()">
                                </div>
                            </div>
                        </div>
                                ...
                                <tr class="fade-row">
                                    ...
                                    <td class="action-table-data">
                                        <div class="edit-delete-action">
                                            <a class="me-2 p-2" href="#" data-bs-toggle="modal" data-bs-target="#edit-subrack" @click="openEditModal(item)">
