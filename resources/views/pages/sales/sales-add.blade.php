    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('generate-sku-btn').addEventListener('click', function(event) {
                ...
                var categoryCode = (categories.find(cat => cat.id == $('#category_id').val()) != null) ?
                    categories.find(cat => cat.id == $('#category_id').val()).code : 'common';
                var brandCode = (brands.find(brand => brand.id == $('#brand_id').val()) != null) ? brands
                    .find(brand => brand.id == $('#brand_id').val()).code : '';
