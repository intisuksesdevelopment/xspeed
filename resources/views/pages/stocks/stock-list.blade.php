...
@section('content')
                ...
                <div class="card-body">
                    <div class="table-top">
                        ...
                        <div class="row g-3 align-items-end">
                                ...
                                <div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="#" @click.prevent="filters.searchBy = 'Periode'">{{ __('common.periode') }}</a></li>
                                        </ul>

                                        <!-- Input -->
                                        <input type="text" class="form-control" :placeholder="`{{ __('label.searchby') }} ${filters.searchBy}...`"
                                            x-model="filters.search" @keyup.debounce.500ms="fetchStocks()">
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- SORT -->
                            <div class="col-md-3">
                                <select class="form-select" x-model="filters.sort" @change="fetchStocks()">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr x-show="!loading && items.length === 0" x-cloak>
                                    <td colspan="13" class="text-center py-3">No data found</td>
                                </tr>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-deletecontent custom-modal-body text-center">
                        ...
                        <h4 class="pt-2 text-muted">Delete Stock</h4>
                        <p>Are you sure you want to delete <strong x-text="itemToDelete?.periode"></strong>?</p>
    ...
    <script>
            ...
            return {
                ...
                async fetchStocks() {
                    ...
                    try {
                        ...
                        let res = await fetch(`${API_STOCK_URL}?${params}`);
                ...
                getStatusClass(status) {
                    switch (status) {
                        case 0: return 'badge-linesuccess';
                        case 1: return 'badge-linedanger';
                        case 2: return 'badge-lines-warning';
                        default: return 'badge-linedanger';
                    }
                },
        ...
        // Global function to refresh stock table
